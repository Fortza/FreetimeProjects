...
def get_token():
    ...
    result = post(url, headers=headers, data=data) # Nå som alle variabler i curl'en er definert legger vi det inn i result
    ...
    return token #returnerer token som er det eneste vi ønsker av json egentlig :) 
