#Programmet åpner opp Paint.
#Brukeren skal bare kjøre skriptet og se hva som dukker opp på skjermen.
#Ment for å lære PyautoGUI som brukes for å automatisere pc mus og tastatur handlinger.
